...
int main(int argc, char **argv)
{
  ...
  if (mysql_real_connect(con, "localhost", "root", "Katya2000+",
  "card_information", 3306, NULL, 0) == NULL)
  {
  ...
  char query[300];
  snprintf(query, 300, "SELECT pin_code, card_amount, card_holdername FROM card WHERE card_number LIKE ('%s')",trans.card_number);
